...
import com.example.mgauge.common.logger.Log
import com.example.mgauge.common.logger.LogView
import com.example.mgauge.common.logger.LogWrapper
import com.example.mgauge.common.logger.MessageOnlyLogFilter
...
class MainActivity : AppCompatActivity() {
    ...
    fun getUsername(): String? {
        ...
        val possibleEmails: List<String?> = LinkedList<String>()
        for (account in accounts) {
            // TODO: Check possibleEmail against an email regex or treat
            // account.name as an email address only for certain account.type values.
           // possibleEmails.ladd(account.name);
    ...
    private fun readData() {
        ...
        Fitness.getHistoryClient(this, getGoogleAccount())
            ...
            .addOnSuccessListener { dataSet ->
                ...
                //system.log ("current username ::::$uNameame");
               ...
               // Log.i(TAG, "UserName: $uName")
                ...
                val cureenttime=ServerValue.TIMESTAMP;
               // map.put("timestamp", ServerValue.TIMESTAMP)

                myRef.setValue("{'user':'Brijesh', 'totalStep':'$total','timestamp':'$cureenttime'}");
               // ref.child("message").updateChildren(map);
            }
